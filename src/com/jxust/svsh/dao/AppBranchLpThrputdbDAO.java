 ...
 */
@Repository
public class AppBranchLpThrputdbDAO {
    @Resource
    ...
    public List<String> getCommitByDate(String date){
        List<String> rst ;
        String sql = "SELECT commit_id FROM app_branchlpthrputdb WHERE mydate='" + date + "'";
        try{
    ...
    public List<Map<String, Object>> getResultByDate(String startDate,String endDate) {
        ...
        String sql = "SELECT * FROM app_branchlpthrputdb WHERE mydate>='" + startDate + "' AND  mydate<='" + endDate + "' ORDER BY mydate  ";
        try {
